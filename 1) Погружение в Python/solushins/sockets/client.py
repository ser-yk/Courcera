...
Вторая версия прошла тесты на курсере.
"""
import socket
import time
...
client.put("palm.cpu", 12.5, timestamp=1503319740)
client.put("palm.cpu", 0.0, timestamp=1503319740)
client.put("palm.cpu", 100.5, timestamp=1503319743)
